...
public class QMetaTypeRegistry {
	...
	private QMetaTypeRegistry() {
		...
		types.add(new QMetaType<java.lang.Void>(QMetaType.Type.Void.getValue(), "void",
		                                        new com.iskrembilen.quasseldroid.qtcomm.serializers.Void()));
		...
		types.add(new QMetaType<Integer>(QMetaType.Type.UserType.getValue(), "BufferId",
		                                 new QInteger()));
		types.add(new QMetaType<Integer>(QMetaType.Type.UserType.getValue(), "NetworkId",
		                                 new QInteger()));
		types.add(new QMetaType<Long>(QMetaType.Type.UInt.getValue(), "uint",
		                              new UnsignedInteger(32)));
		types.add(new QMetaType<Long>(QMetaType.Type.UShort.getValue(), "ushort",
		                              new UnsignedInteger(16)));
		types.add(new QMetaType<Map<String, QVariant<?>>>(QMetaType.Type.UserType.getValue(),
		                "Identity", new QMap<String, QVariant<?>>("QString", "QVariant")));
		types.add(new QMetaType<Integer>(QMetaType.Type.UserType.getValue(), "IdentityId",
		                                 new QInteger()));
		types.add(new QMetaType<Integer>(QMetaType.Type.UserType.getValue(), "MsgId",
		                                 new QInteger()));
		types.add(new QMetaType<BufferInfo>(QMetaType.Type.UserType.getValue(), "BufferInfo",
		                                    new BufferInfoSerializer()));
		types.add(new QMetaType<NetworkServer>(QMetaType.Type.UserType.getValue(),
		                                       "Network::Server", new NetworkServerSerializer()));
		types.add(new QMetaType<IrcMessage>(QMetaType.Type.UserType.getValue(), "Message",
		...
		types.add(new QMetaType<Character>(QMetaType.Type.QChar.getValue(), "QChar",
		                                   new QChar()));
		types.add(new QMetaType<Map<String, QVariant<?>>>(QMetaType.Type.QVariantMap.getValue(),
		                "QVariantMap", new QMap<String, QVariant<?>>("QString", "QVariant")));
		types.add(new QMetaType<List<QVariant<?>>>(QMetaType.Type.QVariantList.getValue(),
		                "QVariantList", new QList<QVariant<?>>("QVariant")));
		types.add(new QMetaType<String>(QMetaType.Type.QString.getValue(), "QString",
		                                new QString()));
		types.add(new QMetaType<List<String>>(QMetaType.Type.QStringList.getValue(),
		                                      "QStringList", new QList<String>("QString")));
		types.add(new QMetaType<Object>(QMetaType.Type.QStringList.getValue(), "QStringList"));
		types.add(new QMetaType<String>(QMetaType.Type.QByteArray.getValue(), "QByteArray",
		                                new QByteArray()));
		...
		types.add(new QMetaType<Calendar>(QMetaType.Type.QDateTime.getValue(), "QDateTime",
		                                  new QDateTime()));
		...
		types.add(new QMetaType<QVariant<Object>>(QMetaType.Type.QVariant.getValue(), "QVariant",
		                new QVariant.QVariantSerializer<Object>()));
		...
		types.add(new QMetaType<Object>(QMetaType.Type.ULongLong.getValue(),
		                                "unsigned long long"));
		types.add(new QMetaType<Object>(QMetaType.Type.Char.getValue(), "qint8"));
		types.add(new QMetaType<Long>(QMetaType.Type.UChar.getValue(), "quint8",
		                              new UnsignedInteger(8)));
		types.add(new QMetaType<Object>(QMetaType.Type.Short.getValue(), "qint16"));
		types.add(new QMetaType<Long>(QMetaType.Type.UShort.getValue(), "quint16",
		                              new UnsignedInteger(16)));
		types.add(new QMetaType<Object>(QMetaType.Type.Int.getValue(), "qint32"));
		types.add(new QMetaType<Long>(QMetaType.Type.UInt.getValue(), "quint32",
		                              new UnsignedInteger(32)));
		types.add(new QMetaType<Object>(QMetaType.Type.LongLong.getValue(), "qint64"));
		types.add(new QMetaType<Long>(QMetaType.Type.ULongLong.getValue(), "quint64",
		                              new UnsignedInteger(32)));
		types.add(new QMetaType<Object>(QMetaType.Type.QVariantList.getValue(),
		                                "QList<QVariant>"));
		types.add(new QMetaType<Object>(QMetaType.Type.QVariantHash.getValue(),
		                                "QHash<QString,QVariant>"));
		types.add(new QMetaType<Object>(QMetaType.Type.QReal.getValue(), "qreal"));

		for (int i = 0; i < types.size(); i++) {
			lookupName.put(types.get(i).name, i);
			if (!lookupId.containsKey(types.get(
			                                  i).id)) { //NB:  Several names map to the same key so don't override it
	...
	public synchronized int getIdForName(String name) {
		if (lookupName.containsKey(name)) {
			return types.get(lookupName.get(name)).id;
		}
	...
	public synchronized QMetaType getTypeForId(int id) {
		...
		//			}
		//		}
		if (lookupId.containsKey(id)) {
			return types.get(lookupId.get(id));
		}
	...
	public synchronized QMetaType getTypeForName(String name) {
		if (lookupName.containsKey(name)) {
			return types.get(lookupName.get(name));
		}
		throw new IllegalArgumentException("Unable to find meta type: " + name);
	}

	public static Object unserialize(Type type, QDataInputStream stream,
	                                 DataStreamVersion version) throws IOException, EmptyQVariantException {
		return instance().getTypeForId(type.getValue()).getSerializer().unserialize(stream,
		                version);
	}
	...
	public static void serialize(Type type, QDataOutputStream stream,
	                             DataStreamVersion version, Object data) throws IOException {
